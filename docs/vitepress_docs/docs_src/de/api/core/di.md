...
Die Instanz wird anhand des Provider-Schlüssels abgerufen und muss eine Unterklasse des angegebenen Typs sein.
...
Erstellt die Standard-Klassenregistrierung.
...
Einfache Klassenregistrierung für Dependency-Lookup.
...
Erstellt eine leere Registrierung.
...
Registriert mehrere Klassen gleichzeitig.
