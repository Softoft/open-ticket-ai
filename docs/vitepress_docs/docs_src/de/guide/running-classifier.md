...
In diesem Abschnitt wird beschrieben, wie man Open Ticket AI für seine Hauptfunktion ausführt: die Klassifizierung von Tickets.
...
*   **Queue Worker**: Holt Tickets ab, verwendet das konfigurierte Modell, um die passende Warteschlange vorherzusagen, und aktualisiert dann das Ticket in Ihrem System (z. B. verschiebt es in die vorhergesagte Warteschlange oder markiert es basierend auf Konfidenzniveaus).
