...
import { shallowRef, inject, computed, ref, watch, onUnmounted, reactive, markRaw, readonly, nextTick, defineComponent, h, mergeProps, useSSRContext, unref, onMounted, watchEffect, watchPostEffect, onUpdated, resolveComponent, createVNode, resolveDynamicComponent, withCtx, renderSlot, createTextVNode, toDisplayString, createBlock, createCommentVNode, openBlock, Fragment, renderList, provide, toHandlers, withKeys, onBeforeUnmount, useSlots, createSSRApp } from "vue";
...
const siteData = deserializeFunctions(JSON.parse(`{"lang":"en-US","dir":"ltr","title":"AI Ticket Classification","description":"A VitePress site","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"footer":{"message":"<b>OTAI</b> - Open Ticket AI","copyright":"by <a href='https://www.softoft.de' target='_blank'>Softoft, Tobias Bück Einzelunternehmen</a>"}},"locales":{"root":{"label":"English","lang":"en","link":"/en/","themeConfig":{"nav":[{"text":"Api","items":[{"text":"Core","items":[{"text":"Ce Core Config","link":"en/api/core/ce_core_config.md"},{"text":"Di","link":"en/api/core/di.md"},{"text":"Mixins","link":"en/api/core/mixins.md"},{"text":"Util","link":"en/api/core/util.md"}]},{"text":"Main","link":"en/api/main.md"},{"text":"Run","items":[{"text":"Managers","link":"en/api/run/managers.md"},{"text":"Pipeline","link":"en/api/run/pipeline.md"},{"text":"Pipes","link":"en/api/run/pipes.md"},{"text":"Ticket System Integration","link":"en/api/run/ticket_system_integration.md"}]}]},{"text":"Architecture","link":"en/architecture.md"},{"text":"Blog","items":[{"text":"Ai In Open Source Ticketsystems","link":"en/blog/ai-in-open-source-ticketsystems.md"},{"text":"Ai In Ticketsystems","link":"en/blog/ai-in-ticketsystems.md"}]},{"text":"Concepts","items":[{"text":"Community Edition Overview","link":"en/concepts/community-edition-overview.md"},{"text":"Key Features","link":"en/concepts/key-features.md"},{"text":"Pipeline Architecture","link":"en/concepts/pipeline-architecture.md"}]},{"text":"Developer Information","link":"en/developer-information.md"},{"text":"Get Started","link":"en/get-started.md"},{"text":"Guide","items":[{"text":"Hardware Requirements","link":"en/guide/hardware-requirements.md"},{"text":"Installation Guide","link":"en/guide/installation-guide.md"},{"text":"Quickstart Guide","link":"en/guide/quickstart-guide.md"},{"text":"Running Classifier","link":"en/guide/running-classifier.md"},{"text":"Training Models","link":"en/guide/training-models.md"}]}]}},"de":{"label":"Deutsch","lang":"de","link":"/de/","themeConfig":{"nav":[{"text":"Api","items":[{"text":"Core","items":[{"text":"Ce Core Config","link":"de/api/core/ce_core_config.md"},{"text":"Di","link":"de/api/core/di.md"},{"text":"Mixins","link":"de/api/core/mixins.md"},{"text":"Util","link":"de/api/core/util.md"}]},{"text":"Main","link":"de/api/main.md"},{"text":"Run","items":[{"text":"Managers","link":"de/api/run/managers.md"},{"text":"Pipeline","link":"de/api/run/pipeline.md"},{"text":"Pipes","link":"de/api/run/pipes.md"},{"text":"Ticket System Integration","link":"de/api/run/ticket_system_integration.md"}]}]},{"text":"Architecture","link":"de/architecture.md"},{"text":"Blog","items":[{"text":"Ai In Open Source Ticketsystems","link":"de/blog/ai-in-open-source-ticketsystems.md"},{"text":"Ai In Ticketsystems","link":"de/blog/ai-in-ticketsystems.md"}]},{"text":"Concepts","items":[{"text":"Community Edition Overview","link":"de/concepts/community-edition-overview.md"},{"text":"Key Features","link":"de/concepts/key-features.md"},{"text":"Pipeline Architecture","link":"de/concepts/pipeline-architecture.md"}]},{"text":"Developer Information","link":"de/developer-information.md"},{"text":"Get Started","link":"de/get-started.md"},{"text":"Guide","items":[{"text":"Hardware Requirements","link":"de/guide/hardware-requirements.md"},{"text":"Installation Guide","link":"de/guide/installation-guide.md"},{"text":"Quickstart Guide","link":"de/guide/quickstart-guide.md"},{"text":"Running Classifier","link":"de/guide/running-classifier.md"},{"text":"Training Models","link":"de/guide/training-models.md"}]}]}}},"scrollOffset":134,"cleanUrls":false}`));
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  props: {
    products: {},
    title: {},
    buttonText: { default: "Choose Plan" },
    buttonHref: {}
  },
  emits: ["cta-click"],
  setup(__props, { emit: __emit }) {
    ref(null);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "pricing-component container py-5" }, _attrs))} data-v-784cef29><h2 class="text-center display-4 fw-bold mb-5" data-v-784cef29>${ssrInterpolate(_ctx.title)}</h2><div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 justify-content-center" data-v-784cef29><!--[-->`);
      ssrRenderList(_ctx.products, (product, index) => {
        _push(`<div class="col" data-v-784cef29><div class="${ssrRenderClass([{ "border-primary border-2": product.featured }, "card h-100 shadow-sm py-3"])}" data-v-784cef29><div class="card-body px-4 py-0 d-flex flex-column" data-v-784cef29><h3 class="card-title fw-bold" data-v-784cef29>${ssrInterpolate(product.name)}</h3><p class="text-body-secondary" data-v-784cef29>${ssrInterpolate(product.description)}</p><div class="my-3" data-v-784cef29><span class="display-5 fw-bolder" data-v-784cef29>$${ssrInterpolate(product.price)}</span>`);
        if (product.pricePeriod) {
          _push(`<span class="text-body-secondary" data-v-784cef29> / ${ssrInterpolate(product.pricePeriod)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><hr data-v-784cef29><ul class="list-unstyled mb-4" data-v-784cef29><!--[-->`);
        ssrRenderList(product.features, (feature, fIndex) => {
          _push(`<li class="d-flex align-items-center mb-3" data-v-784cef29><i class="${ssrRenderClass(["fas", feature.icon, "me-3", "text-primary"])}" data-v-784cef29></i><span data-v-784cef29>${ssrInterpolate(feature.text)}</span></li>`);
        });
        _push(`<!--]--></ul><div class="mt-auto" data-v-784cef29>`);
        if (_ctx.buttonHref) {
          _push(`<a class="${ssrRenderClass(["btn", "w-100", "btn-lg", product.featured ? "btn-primary" : "btn-outline-primary"])}"${ssrRenderAttr("href", _ctx.buttonHref)} data-v-784cef29>${ssrInterpolate(_ctx.buttonText)}</a>`);
        } else {
          _push(`<button class="${ssrRenderClass(["btn", "w-100", "btn-lg", product.featured ? "btn-primary" : "btn-outline-primary"])}" data-v-784cef29>${ssrInterpolate(_ctx.buttonText)}</button>`);
        }
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../.vitepress/components/ProductCards.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const ProductCards = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-784cef29"]]);
const examples = [
  {
    name: "Drucker",
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><h2 class="mb-4 w-100 text-center text-body-emphasis">${ssrInterpolate(unref(t)("otai_prediction_demo_component.title"))}</h2><div class="container my-3"><div class="row justify-content-center"><div class="col-md-12 col-lg-8"><div class="mb-3"><label class="form-label fw-bold" for="demo-example-select">${ssrInterpolate(unref(t)("otai_prediction_demo_component.pickExampleText"))}</label><select id="demo-example-select" class="form-select"><option${ssrRenderAttr("value", -1)} disabled${ssrIncludeBooleanAttr(Array.isArray(selected.value) ? ssrLooseContain(selected.value, -1) : ssrLooseEqual(selected.value, -1)) ? " selected" : ""}>${ssrInterpolate(unref(t)("otai_prediction_demo_component.exampleSelectDefault"))}</option><!--[-->`);
      ssrRenderList(unref(examples), (ex, i) => {
        _push(`<option${ssrRenderAttr("value", i)}${ssrIncludeBooleanAttr(Array.isArray(selected.value) ? ssrLooseContain(selected.value, i) : ssrLooseEqual(selected.value, i)) ? " selected" : ""}>${ssrInterpolate(ex.name)}</option>`);
      });
      _push(`<!--]--></select></div><div class="mb-3"><label class="form-label fw-bold" for="demo-subject">${ssrInterpolate(unref(t)("otai_prediction_demo_component.subjectLabel"))}</label><input id="demo-subject"${ssrRenderAttr("value", subject.value)}${ssrRenderAttr("placeholder", unref(t)("otai_prediction_demo_component.subjectPlaceholder"))} class="form-control" type="text"></div><div class="mb-3"><label class="form-label fw-bold" for="demo-body">${ssrInterpolate(unref(t)("otai_prediction_demo_component.messageLabel"))}</label><textarea id="demo-body"${ssrRenderAttr("placeholder", unref(t)("otai_prediction_demo_component.messagePlaceholder"))} class="form-control" rows="4">${ssrInterpolate(body.value)}</textarea></div><button${ssrIncludeBooleanAttr(loading.value) ? " disabled" : ""} class="btn btn-lg btn-primary mb-4 mt-1" type="button">`);
      if (loading.value) {
        _push(`<span aria-hidden="true" class="spinner-border spinner-border-sm me-1"></span>`);
      } else {
        _push(`<!---->`);
      }
      if (loading.value) {
        _push(`<span role="status">${ssrInterpolate(unref(t)("otai_prediction_demo_component.loadingText"))}</span>`);
      } else {
        _push(`<span class="text-white">${ssrInterpolate(unref(t)("otai_prediction_demo_component.submitButtonText"))}</span>`);
      }
      _push(`</button>`);
      ...
      if (queueResult.value && prioResult.value) {
        _push(`<div class="mt-4"><h3 class="fw-bold text-body-emphasis mb-3">${ssrInterpolate(unref(t)("otai_prediction_demo_component.resultTitle"))}</h3><div class="table-responsive"><table class="table table-dark table-hover align-middle"><thead class="table-light"><tr><th scope="col">${ssrInterpolate(unref(t)("otai_prediction_demo_component.typeColumnHeader"))}</th><th scope="col">${ssrInterpolate(unref(t)("otai_prediction_demo_component.predictionColumnHeader"))}</th><th class="text-center" scope="col">${ssrInterpolate(unref(t)("otai_prediction_demo_component.confidenceColumnHeader"))}</th></tr></thead><tbody><tr><th scope="row">${ssrInterpolate(unref(t)("otai_prediction_demo_component.queueRowHeader"))}</th><td>${ssrInterpolate(queueResult.value[0].label)}</td><td class="text-center"><span class="${ssrRenderClass(["badge", "fs-6", confidenceBadge(queueResult.value[0].score)])}">${ssrInterpolate(formatScore(queueResult.value[0].score))}</span></td></tr><tr><th scope="row">${ssrInterpolate(unref(t)("otai_prediction_demo_component.priorityRowHeader"))}</th><td>${ssrInterpolate(prioResult.value[0].label)}</td><td class="text-center"><span class="${ssrRenderClass(["badge", "fs-6", confidenceBadge(prioResult.value[0].score)])}">${ssrInterpolate(formatScore(prioResult.value[0].score))}</span></td></tr></tbody></table></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div><!--]-->`);
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../.vitepress/components/OTAIPredictionDemo.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "ServicePackagesComponent",
  __ssrInlineRender: true,
  setup(__props) {
    const { t } = useI18n();
    const servicePackages = computed(() => [
      {
        ...
        features: [
          ...
          { text: t("servicePackages.features.standardModel"), icon: "fa-brain" },
          { text: t("servicePackages.features.prioEngine"), icon: "fa-sort-amount-up" },
          { text: t("servicePackages.features.queueClassification"), icon: "fa-sitemap" }
        ]
      },
      {
        ...
        features: [
          { text: t("servicePackages.features.coreInstall"), icon: "fa-rocket" },
          { text: t("servicePackages.features.trainingQueue"), icon: "fa-brain" },
          { text: t("servicePackages.features.trainingPrio"), icon: "fa-brain" },
          { text: t("servicePackages.features.prioEngine"), icon: "fa-sort-amount-up" },
          { text: t("servicePackages.features.queueClassification"), icon: "fa-sitemap" }
        ]
      },
      {
        name: t("servicePackages.enterprise.name"),
        price: 12e3,
        description: t("servicePackages.enterprise.description"),
        features: [
          { text: t("servicePackages.features.coreInstall"), icon: "fa-rocket" },
          { text: t("servicePackages.features.trainingQueue"), icon: "fa-brain" },
          { text: t("servicePackages.features.trainingPrio"), icon: "fa-brain" },
          { text: t("servicePackages.features.prioEngine"), icon: "fa-sort-amount-up" },
          { text: t("servicePackages.features.queueClassification"), icon: "fa-sitemap" },
          { text: t("servicePackages.features.thirdPartyIntegration"), icon: "fa-project-diagram" },
          { text: t("servicePackages.features.customAttributePrediction"), icon: "fa-magic" },
          {
            text: t("servicePackages.features.additionalAttributePrediction"),
            icon: "fa-plus-circle"
          },
          { text: t("servicePackages.features.bespokeDevelopment"), icon: "fa-code-branch" }
        ]
      }
    ]);
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(ProductCards, mergeProps({
        buttonText: unref(t)("servicePackages.buttonText"),
        products: servicePackages.value,
        title: unref(t)("servicePackages.title")
      }, _attrs), null, _parent));
    };
  }
});
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../.vitepress/components/ServicePackagesComponent.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const ServicePackagesComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-7622d806"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "SupportPlansComponent",
  __ssrInlineRender: true,
  setup(__props) {
    const { t } = useI18n();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(ProductCards, mergeProps({
        buttonText: unref(t)("supportPlans.buttonText"),
        products: supportPlans.value,
        title: unref(t)("supportPlans.title")
      }, _attrs), null, _parent));
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../.vitepress/components/SupportPlansComponent.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const deMessages = {
...
const RawTheme = {
  ...
  enhanceApp({ app, router, siteData: siteData2 }) {
    ...
    app.component("OTAIPredictionDemo", _sfc_main$2);
    app.component("ServicePackagesComponent", ServicePackagesComponent);
    app.component("SupportPlansComponent", _sfc_main);
  },
  setup() {
