...
class PipelineConfig(ProvidableConfig):
    ...
    Attributes:
        ...
        pipe_ids (list[str]): Ordered list of all pipe component IDs to execute, starting with a fetcher.
            The list must have at least one element.
    """
    schedule: SchedulerConfig
    # REMOVED fetcher_id. The pipe_ids list is now the complete workflow.
    pipe_ids: list[str] = Field(
        ...,
        min_length=1,
