...
def make_minimal_config_dict():
    ...
    """
    return {
        "system": {"provider_key": "dummy_sys", "params": {}},
        "fetchers": [{"id": "fetch1", "provider_key": "dummy_fetcher", "params": {}}],
        "data_preparers": [{"id": "prep1", "provider_key": "dummy_preparer", "params": {}}],
        "ai_inference_services": [{"id": "model1", "provider_key": "dummy_model", "params": {}}],
        "modifiers": [{"id": "mod1", "provider_key": "dummy_modifier", "params": {}}],
...
@pytest.mark.parametrize("list_name", ["fetchers", "data_preparers", "modifiers", "attribute_predictors"])
